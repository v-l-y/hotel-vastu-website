...
function syncBookingUrlsForEnvironment(){
 ...
 document.querySelectorAll("a[href]").forEach(el=>{
  ...
  if(url.hostname!=="booking.hotelvastu.com")return;
  url.protocol="http:";
