...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin', 'admin.audit'])->group(function () {
        ...
        Route::middleware('admin.role:administrator,front_desk')->group(function () {
            ...
            Route::post('/front-desk/reservations/{reservation}/discount', [FrontDeskController::class, 'applyDiscount'])->name('front-desk.discount');
        ...
        Route::middleware('admin.role:administrator,front_desk,accounts')->group(function () {
            ...
            Route::post('/payments/refunds/{refund}/confirm-manual', [PaymentController::class, 'confirmManualRefund'])->name('payments.refunds.confirm-manual');
