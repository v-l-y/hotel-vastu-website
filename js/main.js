...
function applyHotelIcons(){
 ...
 document.querySelectorAll(".nav-links>a[href]").forEach(a=>{
  ...
  const icon=navMap[href]||((a.getAttribute("href")||"").includes("#booking")?"calendar":null);
